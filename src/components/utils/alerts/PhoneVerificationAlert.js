...
export default function PhoneVerificationAlert({ isShow, onSubmit }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-xl font-medium mt-6">Phone vervication</p>
        <div className="flex self-center">
          <p className="text-sm">Code has been send to</p>
          <p className="font-bold ml-1">+96386796968</p>
        </div>
