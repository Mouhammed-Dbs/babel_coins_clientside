      ...
      <div className="grid grid-cols-1 md:grid-cols-3 h-72 border-t-4 border-indigo-500">
        <div className="p-9 text-lg">
          <div className="flex mb-2">
              <Image src={'/images/logo.svg'} alt='' width={20} height={20}></Image>
              <h1 className="self-center text-xl font-bold ml-2">Babel coins</h1>
          </div>
          <p className="text-sm">it has functioned as a symbol of protection, of perfection, of the Devil, and of humanity</p>
        </div>
